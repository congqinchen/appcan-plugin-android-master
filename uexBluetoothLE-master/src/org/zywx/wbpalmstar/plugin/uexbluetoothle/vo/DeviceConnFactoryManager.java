...
public class DeviceConnFactoryManager{
    ...
    private CallbackConnState callbackConnState;
    /**
     * ESC查询打印机实时状态 缺纸状态
     */
    ...
    private DeviceConnFactoryManager(Build build) {
        ...
        this.id = build.id;
        this.callbackConnState = build._callbackConnState;
    ...
    public void openPort() {
        ...
        switch (deviceConnFactoryManagers[id].connMethod) {
            case BLUETOOTH:
                System.out.println("id -> " + id);
                mPort = new BluetoothPortVo(macAddress);
        ...
        // currentPrinterCommand = PrinterCommand.CPCL;
         sendStateBroadcast(CONN_STATE_CONNECTED);
         callbackConnState.getConnState(0);
        } else {
            if (this.mPort != null) {
                this.mPort = null;
            }
            sendStateBroadcast(CONN_STATE_FAILED);
            callbackConnState.getConnState(1);
        }
    }
    ...
    public static final class Build {
        ...
        private int baudrate;
        private int id;
        private CallbackConnState _callbackConnState;
        ...
        public Build setCallbackConnState(CallbackConnState callbackConnState) {
            this._callbackConnState = callbackConnState;
            return this;
        }
    ...
    public  interface CallbackConnState{
